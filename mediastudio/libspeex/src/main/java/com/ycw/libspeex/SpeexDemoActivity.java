 ...
 * Time: 15:10
 */
public class SpeexDemoActivity extends Activity implements Runnable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speex_demo);

        mPathName = getExternalFilesDir("")+ "/AudiioRecordFile";
        SpeexUtil.getInstance();
        initDatas();
        initUI();
    ...
    public void run() {
        ...
        mRecordingFile = new File(mPathName,mFileName);
