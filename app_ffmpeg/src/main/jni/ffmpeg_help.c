...
#include "com_onion_ffmpeg_FfmpegHelp.h"
//Log
#ifdef ANDROID
#include <jni.h>
 ...
 */
JNIEXPORT jstring Java_com_onion_ffmpeg_FfmpegHelp_urlprotocolinfo(JNIEnv *env, jobject obj){
 ...
 */
JNIEXPORT jstring Java_com_onion_ffmpeg_FfmpegHelp_avformatinfo(JNIEnv *env, jobject obj){
 ...
 */
JNIEXPORT jstring Java_com_onion_ffmpeg_FfmpegHelp_avcodecinfo(JNIEnv *env, jobject obj)
{
char info[40000] = { 0 };
 ...
 */
JNIEXPORT jstring Java_com_onion_ffmpeg_FfmpegHelp_avfilterinfo(JNIEnv *env, jobject obj)
{
char info[40000] = { 0 };
 ...
 * Protocol Support Information
 */
JNIEXPORT jstring Java_com_onion_ffmpeg_FfmpegHelp_configurationinfo(JNIEnv *env, jobject obj)
{
char info[10000] = { 0 };
av_register_all();
